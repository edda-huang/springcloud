...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = "D:/work/springcloud/channel/channel-service";//System.getProperty("user.dir");
        gc.setOutputDir(projectPath + "/src/main/java");//设置代码生成路径
        gc.setFileOverride(true);//是否覆盖以前文件
        gc.setOpen(false);//是否打开生成目录
        gc.setAuthor("黄志华");//设置项目作者名称
        gc.setSwagger2(true);
        ...
        dsc.setUrl("jdbc:postgresql://192.168.3.172:5432/channel");
